...
open class StubVaultRepository : VaultRepository {
    ...
    override suspend fun selectProfile(profileId: UUID): Unit = unused()
    ...
    override suspend fun upsertHealthNote(profileId: UUID, note: HealthNote): Unit = unused()
    override suspend fun deleteHealthNote(profileId: UUID, noteId: UUID): Unit = unused()
